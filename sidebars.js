  ...
  docs: [
    {
      ...
      collapsed: false,
      items: ["index", "intro/upgrading-to-ionic-6"],
    },
    {
      type: "category",
      label: "Content Hub",
      ...
      items: [
        ...
        "Content Hub/update-a-catalog",
        "Content Hub/Explore-a-catalog",

            {
              ...
              items: [
                'Content Hub/Enrich/metrics',
                'Content Hub/Enrich/dataorg',
                'Content Hub/Enrich/project',
              ],
            },
